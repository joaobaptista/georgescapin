    ...
    <tbody>
      <?php foreach ($pagesList as $page): ?>
        ...
        <tr style="<?= $isInactive ? 'opacity: 0.65;' : '' ?>">
          ...
          <td>
            <strong style="font-size: 0.92rem; color: var(--text-primary);"><?= htmlspecialchars($page['name']) ?></strong>
          </td>
          <td>
...
<?php if (!empty($customPages)): ?>
  <div class="atlassian-section-header" style="margin-bottom: 12px;">
    <div class="atlassian-section-title">Páginas Personalizadas Criadas</div>
  </div>
