...
<form method="POST" action="<?= url('/admin/pages/home') ?>" enctype="multipart/form-data">
  ...
  <div class="admin-card">
    <div class="admin-card-header">
      <h3 class="admin-card-title" style="display: flex; align-items: center; gap: 8px;">
        <i data-lucide="layout" size="18" style="color: var(--pastel-blue-accent);"></i> 1. Hero Principal (Topo da Home)
      </h3>
    </div>
    ...
    <div class="form-group">
      ...
      <p class="form-hint">Dica: Você pode usar &lt;br&gt; para quebrar a linha esteticamente.</p>
    </div>
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-top: 15px;">
      <div style="background: var(--bg-surface-hover); padding: 16px; border-radius: var(--radius-sm); border: 1px solid var(--border-light);">
        ...
        <?php if (!empty($hero['bg_image_dark'])): ?>
          <img src="<?= asset($hero['bg_image_dark']) ?>" alt="Hero Dark" style="width: 100%; height: 110px; object-fit: cover; border-radius: var(--radius-sm); border: 1px solid var(--border-light); margin-bottom: 10px; display: block;">
        <?php endif; ?>
      ...
      <div style="background: var(--bg-surface-hover); padding: 16px; border-radius: var(--radius-sm); border: 1px solid var(--border-light);">
        <label style="font-weight: 600; font-size: 0.9rem; color: var(--text-primary); margin-bottom: 10px; display: flex; align-items: center; gap: 8px;">
          <i data-lucide="sun" size="16" style="color: var(--pastel-amber-accent);"></i> Imagem Hero (Modo Claro)
        </label>
        <?php if (!empty($hero['bg_image_light'])): ?>
          <img src="<?= asset($hero['bg_image_light']) ?>" alt="Hero Light" style="width: 100%; height: 110px; object-fit: cover; border-radius: var(--radius-sm); border: 1px solid var(--border-light); margin-bottom: 10px; display: block;">
        <?php endif; ?>
  ...
  <div class="admin-card">
    <div class="admin-card-header">
      <h3 class="admin-card-title" style="display: flex; align-items: center; gap: 8px;">
        <i data-lucide="layers" size="18" style="color: var(--pastel-green-accent);"></i> 2. Seção dos 3 Pilares de Atendimento
      </h3>
    </div>

    <!-- Pilar 1 -->
    <div style="background: var(--bg-surface-hover); padding: 16px; border-radius: var(--radius-sm); border: 1px solid var(--border-light); margin-bottom: 16px;">
      <label style="font-weight: 600; color: var(--text-primary); margin-bottom: 6px; display: block;">Pilar 1 (Título & Descrição)</label>
    ...
    <!-- Pilar 2 -->
    <div style="background: var(--bg-surface-hover); padding: 16px; border-radius: var(--radius-sm); border: 1px solid var(--border-light); margin-bottom: 16px;">
      <label style="font-weight: 600; color: var(--text-primary); margin-bottom: 6px; display: block;">Pilar 2 (Título & Descrição)</label>
    ...
    <!-- Pilar 3 -->
    <div style="background: var(--bg-surface-hover); padding: 16px; border-radius: var(--radius-sm); border: 1px solid var(--border-light);">
      <label style="font-weight: 600; color: var(--text-primary); margin-bottom: 6px; display: block;">Pilar 3 (Título & Descrição)</label>
  ...
  <div class="admin-card">
    <div class="admin-card-header">
      <h3 class="admin-card-title" style="display: flex; align-items: center; gap: 8px;">
        <i data-lucide="sparkles" size="18" style="color: var(--pastel-amber-accent);"></i> 3. Chamada da Seção de Tratamentos em Destaque
      </h3>
    </div>
  ...
  <div class="admin-card">
    <div class="admin-card-header">
      <h3 class="admin-card-title" style="display: flex; align-items: center; gap: 8px;">
        <i data-lucide="help-circle" size="18" style="color: var(--pastel-blue-accent);"></i> 4. Bloco de Dúvidas / Queixas (CTA Inferior da Home)
      </h3>
    </div>
  ...
  <div style="display: flex; gap: 12px; margin-top: 25px; margin-bottom: 50px;">
    <button type="submit" class="btn-admin btn-primary" style="padding: 12px 30px;">
      <i data-lucide="save" size="16"></i> Salvar Conteúdo da Home
    </button>
